...
export const profile: Profile = {
  ...
  timezone: 'UTC-3',
  lead: 'I build the frontend of Calcubox, a financial operations platform for SMBs: 18 business modules, the design system underneath them, and the electronic invoicing UI.',
  about: [
