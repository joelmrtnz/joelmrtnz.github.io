...
export const profile: Record<Lang, Profile> = {
  en: {
    ...
    about: [
      ...
      "I have been building Calcubox's frontend since January 2024, first through Miniviable and full-time since 2025.",
    ],
    links: LINKS,
    stack: STACK,
    education: {
  ...
  es: {
    ...
    about: [
      ...
      'Trabajo en el frontend de Calcubox desde enero de 2024, inicialmente a través de Miniviable y de forma full-time desde 2025.',
    ],
    links: LINKS,
    stack: STACK,
    education: {
