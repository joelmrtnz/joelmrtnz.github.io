...
export const experience: Role[] = [
  {
    ...
    highlights: [
      '18 business modules on Next.js 16, React 19, TypeScript and RTK Query, replacing the legacy system 11 client companies were already running on.',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Built the first version of the Calcubox design system, 20 components on Radix UI and Tailwind, then rebuilt it from scratch on Mantine in January 2024. That rewrite is what the product runs on today.',
    ],
  },
];
